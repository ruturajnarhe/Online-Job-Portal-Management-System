...
function JobDetails() {
  ...
  const checkApplication = async () => {
    ...
    try {
      ...
      /*
       * The backend identifies the current applicant
       * from the JWT token.
       *
       * Therefore, no applicant ID is required.
       */
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      /*
       * The backend gets the applicant from the JWT.
       * Only the job ID is required in the request body.
       */
      const application = {
        job: {
          id: Number(id),
